  ...
  return {
    initFS: function(persistent, size) {
      output('<div>Welcome to ' + document.title +
             ' Power User Backend! (v<span class="sails-version">' + VERSION_ + '</span>)</div>');
      output((new Date()).toLocaleString());
      output("<p>You can use this terminal to modify and rename files in your SAILSs file system. To see the" +
